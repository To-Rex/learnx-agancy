      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="bg-white p-8 rounded-2xl shadow-lg">
          ...
          <div className="h-96 rounded-xl overflow-hidden">
            <iframe src="https://yandex.uz/maps/10335/tashkent/house/YkAYdAZiQUAAQFprfX91cH1lZw==/?ll=69.213107%2C41.341247&z=20.6" width="100%" height="100%" frameBorder="0" allowFullScreen className="rounded-xl" title="UnoGroup location"></iframe>
          </div>
        </motion.div>
      </div>
    </div>
