...
import { Mail, Phone, MapPin, Calendar, FileText, CheckCircle, Edit, Upload, Download, Eye, Trash2, Plus, IdCard, Trash, X, ArrowUp, ArrowDown } from 'lucide-react';
              ...
              {applications.length > 0 ? (
                <div className="space-y-4">
                  {displayedApps.map((app: any) => (
                    <div key={app.id} className="cursor-pointer border-2 border-dashed border-gray-200 hover:border-gray-300 hover:shadow-sm rounded-lg p-6 transition-shadow bg-white ">
