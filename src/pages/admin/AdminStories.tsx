    ...
    <section>
      ...
      {storyDeleteModal && (
        <div className='fixed inset-0 backdrop-blur-sm flex justify-center items-center rounded-md '>
          <div className='bg-gray-50 shadow-2xl p-6 rounded-2xl  ml-24 max-w-[570px]'>
      ...
      {showStoryModal && (
        <div className="fixed inset-0 z-50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-gray-50 shadow-2xl rounded-2xl p-6 w-full max-w-xl max-h-[90vh] overflow-y-auto border border-white/20">
            ...
            <div className="space-y-6">
              <div>
                ...
                <input type="text" name="name" value={storyForm.name || ''} onChange={(e) =>
                  ...
                  className="w-full px-4 py-3 border border-gray-500 rounded-lg text-gray-500 placeholder-gray-600 backdrop-blur-lg focus:outline-none focus:border-gray-400 focus:ring-2 focus:ring-gray-400 transition-all duration-300"
                  required />
                <label className="block text-gray-600 text-sm font-semibold mb-2">
                  Qaysi mamlakat</label>
              ...
              <div>
                ...
                <input type="file" onChange={(e) =>
                  ...
                  className='border w-full rounded-lg py-2 border-gray-500 text-gray-500'
                />
