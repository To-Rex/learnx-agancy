...
const AdminProfile = () => {
    ...
    return (
        <section className="border border-white/40 p-4 my-3 rounded-xl ">
            <div className=" min-h-[72vh] backdrop-blur-sm text-gray-800">
                ...
                <div className="flex justify-between items-center px-8 py-4">
                    ...
                    <div className="relative">
                        <select
                            className="appearance-none outline-none p-2 pr-8 rounded-lg bg-transparent border border-gray-600 text-center">
                            <option>Admin</option>
                ...
                <div className="flex flex-col justify-around px-6 ">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <input type="password"
                            ...
                            className="w-full border border-gray-400 rounded-lg bg-white/5 p-2 text-gray-500 placeholder-gray-400 backdrop-blur-lg focus:outline-none focus:border-gray-600 mb-2" />
                        <button type="button"
                            className="w-[230px] border p-2 rounded-lg text-white  bg-blue-400 hover:bg-blue-500 active:scale-95 transition">
