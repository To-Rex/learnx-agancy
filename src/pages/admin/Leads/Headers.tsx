...
const Headers: React.FC = () => {
  ...
  const navItems = [
    { path: "/admin/leads/call-manager", label: "Call Manager", icon: Home },
    ...
    { path: "/admin/leads/document-manager", label: "Document Manager", icon: Calendar },
    { path: "/admin/leads/document-employee", label: "Document Employee", icon: Calendar }
  ];
