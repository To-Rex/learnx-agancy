...
const CallAgentPage = () => {
  ...
  const fetchLeads = async () => {
    ...
    try {
      const res = await fetch(
        "https://learnx-crm-production.up.railway.app/api/v1/leads/get-list",
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        "https://learnx-crm-production.up.railway.app/api/v1/leads/create",
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${
        ...
        <Card className="w-full max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              The lead information has been sent to the consulting manager for
      ...
      <div className="min-h-screen bg-background max-w-[1200px] border rounded-xl shadow-sm mx-auto p-4">
        ...
        <div className="mb-4 p-2 rounded-xl pl-6">
          ...
          <p className="text-muted-foreground text-sm">
            Complete the lead details for consulting assignment
          </p>
        </div>
