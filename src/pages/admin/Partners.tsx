    ...
    <section className="my-3 border border-white/5 bg-gray-100 shadow-sm overflow-hidden rounded-xl">
      ...
      {showPartnerModal && (
        <div className="fixed inset-0 z-50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-gray-50 shadow-lg rounded-2xl  ml-24  p-6 w-full max-w-xl border border-white/20">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-gray-500 text-sm font-semibold mb-2">Hamkor nomi (En)</label>
              ...
              <div>
                <label className="block text-gray-500 text-sm font-semibold mb-2">Hamkor nomi (Ru)</label>
              ...
              <div>
                <label className="block text-gray-500 text-sm font-semibold mb-2">Hamkor nomi (Uz)</label>
              ...
              <div>
                <label className="block text-gray-500 text-sm font-semibold mb-2">Rasm</label>
